...
/* This is for testing out scrolling and other freatures visually on the main page
*   before making changes to page_layout
* 
*/
...
const TestLayout = (props) => {
  ...
  return(
      ...
      <div className="grid-y grid-margin-y grid-frame wrapper2" > 
